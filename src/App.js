...
import Hrservices1 from "./components/Hr/Hrservices1";
...
import Hrservices2 from "./components/Hr/Hrservices2.js";
    ...
    <>
      ...
      {!hasError && (
        <Routes onError={handleError} onLoad={resetError}>
          ...
          <Route path="/hr1" element={<Hrservices1 />} />
          <Route path="/hr2" element={<Hrservices2 />} />
        </Routes>
      )}
    </>
  );

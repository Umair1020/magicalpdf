...
// Callback function to update pdfFile state
const handlePdfFileChange = (newPdfFile) => {
  ...
  return (
    <>
      ...
      <Desktop>
        ...
        >
          <div style={{ flexBasis: "50%", flexGrow: 0, flexShrink: 0 }}>
          <PdfHeader pdfFile={pdfFile} onPdfFileChange={handlePdfFileChange}  />
          </div>
          <div
            style={{
              flexBasis: "50%",
